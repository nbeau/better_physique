            ...
            <div className="modal_container">
                ...
                <div className="row m-2 mb-5 gy-3">
                    ...
                    {(data.search === "exercises" && exercises.map((e) => (
                        ...
                        (data.exercise_goal === "any" && <Card title={e.title} title_fr={e.title_fr} img={e.img} rating={e.rating} rating_num={e.rating_num} link={e.link} lang={lang} />
                        ||
                        (data.exercise_goal === "strength" && e.strength && <Card title={e.title} title_fr={e.title_fr} img={e.img} rating={e.rating} rating_num={e.rating_num} link={e.link} lang={lang} />)
                        ||
                        (data.exercise_goal === "hypertrophy" && e.hypertrophy && <Card title={e.title} title_fr={e.title_fr} img={e.img} rating={e.rating} rating_num={e.rating_num} link={e.link} lang={lang} />)
                        ) ||
                        (data.exercise_goal === "endurance" && e.endurance && <Card title={e.title} title_fr={e.title_fr} img={e.img} rating={e.rating} rating_num={e.rating_num} link={e.link} lang={lang} />)
                        )))
                    )) || (data.search === "recipes" && recipes.map((e) => (
                        (e.title.toLowerCase().includes(search.toLowerCase()) &&
                        (data.dieting_goal === e.type || data.dieting_goal === "any") &&
                        <Card title={e.title} title_fr={e.title_fr} img={e.img} rating={e.rating} rating_num={e.rating_num} link={e.link} lang={lang} />
                        )
                    )))}
                </div>
            </div>
